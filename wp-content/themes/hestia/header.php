...
<head>
	...
	<?php endif; ?>
	<?php wp_head(); ?>
    <link rel="stylesheet" href="<?php echo get_template_directory_uri() . '/assets/css/mystyles.css'; ?>"  type="text/css" >
    <script type="text/javascript" <?php echo 'src="'.get_template_directory_uri() . '/assets/js/Miscript.js"'; ?> ></script>
</head>
